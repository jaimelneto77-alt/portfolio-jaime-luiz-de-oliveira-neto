...
[![Currículo](https://img.shields.io/badge/Currículo-000000?style=for-the-badge&logo=read-the-docs&logoColor=white)]([./CV/jaime-neto.pdf](https://github.com/jaimelneto77-alt/portfolio-jaime-luiz-de-oliveira-neto/blob/main/CV/Jaime_L_Neto%20(1).pdf)
...
**Hospital Estadual Sapopemba** — *13+ anos*
Gestão de prontuários médicos, laudos técnicos e suporte à gestão hospitalar, sempre com rigor e precisão em ambiente de alta complexidade.

**Contrasti Comércio de Acessórios**
Atendimento ao cliente, controle de estoque e conformidade fiscal, com aumento de 20% na satisfação do cliente e redução de 15% nos erros de estoque. Essa vivência despertou o interesse por dados e organização de processos, o que motivou o início do curso de Análise e Desenvolvimento de Sistemas na UNICID, unindo a bagagem administrativa a novas competências técnicas na área de tecnologia.
...
| :--- | :--- | :---: |
| Engenharia de Contexto e Lógica Física | Disciplina focada em organizar, filtrar e apresentar informações de modo que o sistema (seja uma IA ou um software) compreenda exatamente o cenário em que está operando | [Ver Projeto](https://github.com/jaimelneto77-alt/portfolio-jaime-luiz-de-oliveira-neto/tree/main/Engenharia-de-Contexto-e-L%C3%B3gica-F%C3%ADsica) |
| Projeto Traduzindo Lógica Para Python | Desenvolvimento de um framework em Python que converte modelos teóricos de Engenharia de Contexto e Lógica Física em sistemas funcionais | [Ver Projeto](https://github.com/jaimelneto77-alt/portfolio-jaime-luiz-de-oliveira-neto/tree/main/Projeto-Traduzindo-logica-para-python) |
...
| Projeto Desenhando Emojis Com Dados | Exploração criativa de estruturas de dados para a geração de ícones visuais, utilizando matrizes e coordenadas lógicas em Python para traduzir fluxos de dados em representações gráficas (emojis) | [Ver Projeto](https://github.com/jaimelneto77-alt/portfolio-jaime-luiz-de-oliveira-neto/tree/main/Projeto_desenhando_emojis_com_dados) |
| Engenharia de Soluções Lógicas | Criação de arquiteturas de sistemas focadas na resolução de problemas complexos, integrando análise de requisitos, lógica de programação e estruturação de dados para entregar soluções escaláveis e eficientes | [Ver Projeto](https://github.com/jaimelneto77-alt/portfolio-jaime-luiz-de-oliveira-neto/tree/main/Projeto_desenhando_emojis_com_dados) |
| Construção de Portfólio Profissional | Aplicação de tecnologia e automação para otimizar processos operacionais e de gestão, transformando décadas de conhecimento prático em soluções digitais inteligentes e eficientes | [Ver Projeto](https://github.com/jaimelneto77-alt/portfolio-jaime-luiz-de-oliveira-neto/tree/main/Constru%C3%A7%C3%A3o_de_Portf%C3%B3lio_Profissional) |
...
├── CV/
│   └── jaime-neto.pdf
├── Engenharia-de-Contexto-e-Lógica-Física/README.md
├── Projeto-Traduzindo-logica-para-python/README.md
├── Projeto-engenharia-de-contexto-e-lógica-física/README.md
├── Projeto-modularização/README.md
├── Projeto_desenhando_emojis_com_dados/README.md
├── Construção_de_Portfólio_Profissional/README.md
